...
$sql="SELECT rank, adventurerid, displayname, score FROM
(SELECT func_count_row() AS rank, adventurerid, displayname, score FROM
(SELECT adventurerid, displayname, SUM(a.score) AS score
